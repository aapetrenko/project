...
namespace panther {
    ...
    public:
        ...
        void search_one_direction(T& result_direction,
                                  T& index,
                                  T start,
                                  int direction,
                                  const std::function<T(const T * const)> &f,
                                  T left_border,
                                  T right_border,
                                  T* starting_point,
                                  int n,
            ...
            result_direction = f(result_for_axis);
            if (result_direction < start) {
                index = direction + 1;
                return;
            }
...
#endif //PANTHER_MASTER_PARALLCOORDDESCMETHOD_H